namespace LinuxHub.Common.Data
{
    ...
    /// próprio catálogo assinado via <c>LINUXHUB_CATALOG_BASE_URL</c> (mesmo espírito do
    /// <c>--filepool-base-url</c> do REDACTED, mas por variável de ambiente em vez de argumento
    /// de linha de comando: este app ainda não tem parsing de CLI, e introduzi-lo só para isto
    /// seria escopo além do que esta mudança pede).
    ///
